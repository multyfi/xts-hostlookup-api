...
module.exports = class XTSInteractive {
   ...
   *   localIP parameter is used to bind the outgoing requests to a specific local IP address.
   *
   */
  ...
  /**
   * Returns localIP used to bind the outgoing requests.
   *
   *
   * @return
   *   the localIP used to bind the outgoing requests to a specific local IP address.
   */
  get localIP() {
